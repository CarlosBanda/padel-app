...
import 'package:padel_app/views/screens/login_page.dart';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text("¿Ya tienes cuenta?", style: TextStyle(fontSize: 15)),
                  TextButton(
                    onPressed: () {
...
class _FormInputsState extends State<_FormInputs> {
  ...
  InputDecoration inputPassConfirm() => InputDecoration(
    hintText: '********',
    hintStyle: const TextStyle(color: Colors.white),
    enabledBorder: const OutlineInputBorder(
      borderSide: BorderSide(color: Colors.white),
